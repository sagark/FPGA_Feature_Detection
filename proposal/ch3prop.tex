...
\noindent\includegraphics[scale=0.15]{modules/octave.png}
...
\noindent\includegraphics[scale=0.15]{modules/x_window.png}

Y Window Module:

\noindent\includegraphics[scale=0.15]{modules/y_window.png}
