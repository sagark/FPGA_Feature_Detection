...
\includegraphics[width=\textwidth]{processed_image_pngs/full_pipe_blackbox.png}
...
\begin{wrapfigure}{r}{0.25\textwidth}
    \includegraphics[width=0.23\textwidth]{processed_image_pngs/black_box_modules/Downsampler_blackbox.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.25\textwidth}
    \includegraphics[width=0.23\textwidth]{processed_image_pngs/black_box_modules/Upsampler_blackbox.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.25\textwidth}
    \includegraphics[width=0.23\textwidth]{processed_image_pngs/black_box_modules/Downsamplerwrap_blackbox.png}
\end{wrapfigure}
...
Downsamplerwrap\_blackbox.png

\subsubsection{UpsamplerWrap.v, Upsampler4xWrap.v}

\begin{wrapfigure}{r}{0.25\textwidth}
    \includegraphics[width=0.23\textwidth]{processed_image_pngs/black_box_modules/Upsamplerwrap_blackbox.png}
\end{wrapfigure}
...
% [todo] - check4 blackbox representation Check4\_blackbox.png
...
\begin{wrapfigure}{r}{0.25\textwidth}
    \includegraphics[width=0.23\textwidth]{processed_image_pngs/black_box_modules/Octave_blackbox.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.25\textwidth}
    \includegraphics[width=0.23\textwidth]{processed_image_pngs/black_box_modules/five_by_five_window_blackbox.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.25\textwidth}
    \includegraphics[width=0.23\textwidth]{processed_image_pngs/black_box_modules/x_window_blackbox.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.25\textwidth}
    \includegraphics[width=0.23\textwidth]{processed_image_pngs/black_box_modules/five_row_array_blackbox.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.25\textwidth}
    \includegraphics[width=0.23\textwidth]{processed_image_pngs/black_box_modules/y_window_blackbox.png}
\end{wrapfigure}
